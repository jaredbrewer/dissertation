...
%\chapter[Response to Reviewers for \citep{Brewer2022}]{Response to Reviewers for \citep{Brewer2022}\footnote{Lightly edited for structure and grammar, all content and critiques are left unmodified.}}\label{r2r}
%
%\begin{doublespace}
%\input{appendixB.tex}
%\end{doublespace}
